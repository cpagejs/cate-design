<template>
  <div class="main">
    <c-form-item label="用户名" prop="username" :rules="schema.username">
      <c-input v-model="formValues.name" placeholder="请输入username"></c-input>
    </c-form-item>
    <c-form-item label="密码" prop="password" :rules="schema.password">
      <c-input
